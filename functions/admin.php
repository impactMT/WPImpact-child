...
function my_custom_login_logo() { 
     echo '<style type="text/css"> h1 a { background-image:url('.get_stylesheet_directory_uri().'/functions/images/custom-login-logo.jpg) !important; } </style>';}   
...
// Add(true) or Remove(false) SEO Columns
